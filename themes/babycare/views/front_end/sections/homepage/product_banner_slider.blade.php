        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-4 col-12">
                <div class="two-colum-inner">
                    <div class="label"
                        id="{{ $section->product_banner_slider->section->sub_title->slug ?? '' }}_preview">
                        {!! $section->product_banner_slider->section->sub_title->text ?? '' !!}</div>
                    ...
                    <a href="#" class="btn"
                        id="{{ $section->product_banner_slider->section->button->slug ?? '' }}_preview">
                    ...
                    @foreach ($modern_products as $m_product)
                        <div class="product-card">
                            <div class="product-card-inner">
                                <div class="text-center product-content-top">
                                    <div class="label">
                                ...
                                <div class="favorite-icon">
                                    ...
                                    <div class="product-btn-wrp">
                                        ...
                                        @if (isset($module) && $module->isEnabled())
                                            ...
                                            @include('productquickview::pages.button', [
                                                'product_slug' => $m_product->slug ?? null,
                                                'slug' => $slug ?? null,
                                        ...
                                        @if (isset($compare_module) && $compare_module->isEnabled())
                                            {{-- Include the module blade button --}}
                                            @include('productcompare::pages.button', [
                                                'product_slug' => $m_product->slug ?? null,
                                                'slug' => $slug ?? null,
                                                'currentTheme' => $currentTheme,
                                            ])
                                ...
                                <div class="product-img">
                                    <a href="#">
                                        <img src="{{ asset($m_product->cover_image_path ?? '') }}" alt="product-img">
                                    </a>
                                </div>
                                <div class="text-center product-content-bottom">
                                    <div class="price-label2">
                                        @if ($m_product->variant_product == 0)
                                            <div class="price">
                                                <ins>{{ currency_format_with_sym($m_product->sale_price ?? $m_product->price, $store->id, $currentTheme) }}
                                                </ins>
                                            </div>
                                        @else
                                            <div class="price">
