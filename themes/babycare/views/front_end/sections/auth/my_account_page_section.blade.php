<section class="my-account-page padding-bottom  padding-top  {{ $option->class_name }}"
                ...
                <div class="my-acc-rightbar">
                    ...
                    <div id="tab-5" class="my-acc-right-content">
                        ...
                        <div class="order-history-frame">
                            ...
                            <div class="text-right right-result-tbl">
                                        ...
                                        <tr>
                                            <td data-label="Product">
                                                <a href="product.html" class="pro-img-cart">
                                                    <img
                                                        src="{{ asset('themes/' . $currentTheme . '/assets/images/cart.png') }}">
                                                </a>
                                            </td>
                                            <td data-label="Name">
