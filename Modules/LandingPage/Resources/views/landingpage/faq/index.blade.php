            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    {{--  Start for all settings tab --}}
                        ...
                        <div class="card">
                            {{ Form::open(array('route' => 'admin.faq.store', 'method'=>'post', 'enctype' => "multipart/form-data")) }}
                            @csrf
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="{{ route('admin.faq_create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" data-title="{{__('Discover Feature Create')}}"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                    ...
                                                                    data-url="{{ route('admin.faq_edit',$key) }}"  data-size="lg"
                                                                        data-ajax-popup="true" data-title="{{ __('Edit Page') }}">
                                                                        <i class="ti ti-pencil py-1" data-bs-toggle="tooltip" title="edit"></i>
                                                                    </button>
                                                                    {!! Form::open(['method' => 'GET', 'route' => ['admin.faq_delete', $key], 'class' => 'd-inline']) !!}
