                ...
                <div class="col-xl-9">
                    {{--  Start for all settings tab --}}
                        ...
                        <div class="card">
                            ...
                            {{ Form::open(array('route' => 'admin.features.store', 'method'=>'post', 'enctype' => "multipart/form-data")) }}
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="{{ route('admin.feature_create') }}" data-ajax-popup="true"   data-bs-toggle="tooltip" data-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                    ...
                                                                    data-url="{{ route('admin.feature_edit',$key) }}" data-size="lg"
                                                                    data-ajax-popup="true" data-title="{{ __('Edit Page') }}">
                                                                    <i class="ti ti-pencil py-1" data-bs-toggle="tooltip" title="edit"></i>
                                                                    </button>
                                                                    {!! Form::open(['method' => 'GET', 'route' => ['admin.feature_delete', $key], 'class' => 'd-inline']) !!}
                        ...
                        <div class="card">
                            ...
                            {{ Form::open(array('route' => 'admin.feature_highlight_create', 'method'=>'post', 'enctype' => "multipart/form-data")) }}
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="{{ route('admin.features_create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" data-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="d-flex">
                                                                    <button class="btn btn-sm btn-primary me-2"
                                                                    data-url="{{ route('admin.features_edit',$key) }}" data-size="lg"
                                                                    data-ajax-popup="true" data-title="{{ __('Edit Page') }}">
                                                                    <i class="ti ti-pencil py-1" data-bs-toggle="tooltip" title="edit"></i>
                                                                    </button>
                                                                    {!! Form::open(['method' => 'GET', 'route' => ['admin.features_delete', $key], 'class' => 'd-inline']) !!}
                                                                    <button type="button" class="btn btn-sm btn-danger show_confirm">
                                                                    <i class="ti ti-trash text-white py-1"></i>
                                                                    </button>
                                                                    {!! Form::close() !!}
