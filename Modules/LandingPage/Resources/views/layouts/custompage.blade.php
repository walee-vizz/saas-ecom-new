...
<head>
    ...
    <meta name="author" content="neotronicdev.com" />
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md default top-nav-collapse">
                <div class="header-left">
                    <a class="bg-transparent navbar-brand" href="{{ url('/') }}">
                        ...
                        <div class="col-12">
                            <div class="p-4 rounded bg-primary">
                                <div class="row gy-3 align-items-center">
                                    ...
                                    <div class="col-xxl-6 col-lg-6">
                                        <div
                                            class="gap-3 d-flex align-items-center justify-content-center justify-content-sm-end">
                                            <div class="text-end">
