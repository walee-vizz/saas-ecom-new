...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
    <link rel="icon" href="{{ asset('authorizenet/assets/images/favicon.png') }}">
    <link rel="stylesheet" href="{{ asset('authorizenet/assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('authorizenet/assets/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('authorizenet/assets/css/responsive.css') }}">
    <link rel="stylesheet" href="{{ asset('authorizenet/assets/css/daterangepicker.css') }}">
    <style>
        .expiration input {
            border: 0;
        }
...
<body class="theme-1">
    @php
        $other_info = is_string($req_data['billing_info'])
            ? (array) json_decode($req_data['billing_info'])
            : $req_data['billing_info'];
    @endphp
            ...
            <div class="card">
                <div class="card-body w-100">
                    ...
                    <form class="payment-form" method="post"
                        action="{{ route('order.get.authorizenet.status', $slug) }}" id="authorizenetForm">
                        @csrf
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Name"
                                        value="{{ $other_info['firstname'] }}" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
    ...
    <script src="{{ asset('authorizenet/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('authorizenet/assets/js/custom.js') }}"></script>
    <script
