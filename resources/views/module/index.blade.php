        ...
        <div class="col-xl-3">
            <div class="card sticky-top " style="top:60px">
                <div class="list-group list-group-flush addon-set-tab" id="useradd-sidenav">
                    <ul class="gap-3 nav nav-pills flex-column w-100" id="pills-tab" role="tablist">
                        <li class="nav-item " role="presentation">
                            <a href="#premiuem"
                                class="text-center border-0 nav-link active list-group-item list-group-item-action rounded-1 f-w-600"
                        ...
                        <li class="nav-item " role="presentation">
                            <a href="#themes"
                                class="text-center border-0 nav-link list-group-item list-group-item-action rounded-1 f-w-600"
                        ...
                        <div class="col-md-12">
                                        ...
                                        <div class="card-body package-card-inner d-flex align-items-center">
                                            ...
                                            <div class="px-3 package-content flex-grow-1">
                                                ...
                                                <div class="text-muted">
                                                    {{ __('+' . (count($modules) - 1) . ' Premium Add-on') }}
                                                </div>
                                            </div>
                                            <div class="gap-2 d-flex align-items-center">
                                                <div class="price">
                                                    <a class="btn btn-primary"
                                                        href="https://workdo.io/product-category/theme-addon/ecommercego-addon/"
                                                        target="new">
                                                        {{ __('Buy More Add-on') }}
                                                    </a>
                                                </div>
                            ...
                            <div class="px-0 event-cards row">
                                ...
                                @foreach ($modules as $module)
                                    ...
                                    @endphp
                                    @if (
                                        (!isset($json['display']) || $json['display'] == true || $module_name == 'GoogleCaptcha') &&
                                            $module_name != 'LandingPage')
                                        <div class="h-auto col-xl-2 col-lg-3 col-md-4 col-sm-6 product-card">
                                            <div
                                                ...
                                                <div class="product-img">
                                                    ...
                                                    <div class="checkbox-custom">
                                                        <div class="btn-group card-option">
                                                            <button type="button" class="p-0 btn" data-bs-toggle="dropdown"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                                ...
                                                                <form
                                                                    action="{{ route('module.remove', $module->getName()) }}"
                                                                    method="POST" id="form_{{ $id }}">
                                                                    @csrf
                                                                    <button type="button"
                                                ...
                                                <div class="product-content">
                                                    <h4 class="text-capitalize">
                                                        {{ Module_Alias_Name($module->getName()) }}</h4>
                            ...
                            @if (isset($theme['add_ons']))
                                @foreach ($theme['add_ons'] as $key => $value)
                                    @if (!in_array(strtolower($value['name']), array_map('strtolower', $module_array)))
                                        <div class="h-auto col-xl-2 col-lg-3 col-md-4 col-sm-6 product-card">
                                            <div class="mb-0 card h-100 justify-content-between">
                                                <div class="product-img">
                                                    <div class="theme-main">
                                                        <div class="theme-avtar">
                                    ...
                                    <div class="card">
                                        <div class="card-body package-card-inner d-flex align-items-center">
                                            ...
                                            <div class="price text-end">
                                                <a class="btn btn-primary"
                                                    href="https://workdo.io/product-category/apps/?utm_source=ecom-main-file&utm_medium=superadmin&utm_campaign=superadmin-btn-mobile-all"
                                                    target="new">
                                            ...
                                            <div class="product-card ">
                                                <div class="product-card-inner">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        @if (!in_array($value[0], $theme_array))
                                                            <div class="gap-2 product-content-bottom d-flex">
                                                                <a href="{{ $value[2] }}?utm_source=ecom-main-file&utm_medium=superadmin&utm_campaign=superadmin-btn-mobile-{{ $value[0] }}"
                                                                    target="_new"
                                                                    class="mt-2 btn btn-outline-primary w-100">{{ __('Mobile App') }}</a>
                                                            </div>
                                                        @else
                                                            <a href="{{ $value[2] }}" target="_new"
                                                                class="mt-2 btn btn-outline-primary w-100">{{ __('Buy Now') }}</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
