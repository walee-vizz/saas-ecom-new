...
<head>
    ...
    <title>{{ isset($setting['title_text']) ? $setting['title_text'] : env('APP_NAME') ?? 'Ecommercego saas' }} -
    ...
    <!-- Favicon icon -->
    <link rel="icon"
        href="{{ asset(isset($setting['favicon']) ? $setting['favicon'] . '?timestamp=' . time() : 'uploads/logo/logo-sm.svg' . '?timestamp=' . time()) }}"
        type="image/x-icon" />
    ...
    <style>
        {!! isset($setting['storecss']) ? $setting['storecss'] : '' !!} :root {
    ...
    <script>
        function add_more_choice_option(i, name) {
            ...
            $('#attribute_options').append(
                ...
                '<div class="p-0 form-chec1k form-switch">' +
                ...
                '<div class="p-0 for-variation_data form-chec1k form-switch d-none use_for_variation" id="use_for_variation"  data-id="' +
                i + '">' +
