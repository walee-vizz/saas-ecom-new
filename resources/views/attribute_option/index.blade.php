...
@section('action-button')
    ...
    <div class=" text-end d-flex all-button-box justify-content-md-end justify-content-center">
        <a href="#" class="btn btn-sm btn-primary add_attribute" data-ajax-popup="true" data-size="md"
            ...
            data-url="{{ route('product-attribute-option.create', $attribute->id) }}" data-toggle="tooltip"
            ...
            <div class="card mt-5">
                <div class="card-body">
                                    ...
                                    @foreach ($attribute_option as $option)
                                        <li class="d-flex align-items-center justify-content-between list-group-item"
                                            ...
                                            <span class="float-end">
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['product-attribute-option.destroy', $option->id],
                                                    'class' => 'd-inline',
                                                ]) !!}
                    ...
                    <p class=" mt-4"><strong>{{ __('Note') }} :
                        </strong><b>{{ __('You can easily change attribute option of attribute using drag & drop.') }}</b>
                    </p>
                </div>
            </div>
        </div>
