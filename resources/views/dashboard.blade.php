        ...
        <div class="col-sm-12">
            <div class="row ">
                    ...
                    <div class="mb-4 row g-3">
                        <div class="col-xxl-12">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ $totalproduct ?? 0 }} <span class="text-sm text-success">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ $totle_sales ?? 0 }} <span class="text-sm text-danger">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ $totle_order ?? 0 }}<span class="text-sm text-success">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="row g-3">
                                        ...
                                        <div class="col-xxl-6 col-lg-3 col-sm-6 col-12">
                                            <div class="card stats-wrapper info-card">
                                                <div class="card-body stats">
                                                    ...
                                                    <h3 class="mb-0">
                                                        {{ currency_format_with_sym($total_revenues ?? 0, auth()->user()->current_store, APP_THEME()) ?? SetNumberFormat($total_revenues ?? 0) }}
                                                        ...
                                                        <div class="card-body stats ps-3 pe-3">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div id="sharingButtonsContainer"
                                                                    ...
                                                                    style="display: none;">
                                                                    <div
                                                                        class="hidden mb-5 Demo1 d-flex align-items-center justify-content-center">
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="col-xxl-6">
                                    <div class="p-3 mb-0 theme-card dashboard-theme-card card">
                ...
                <div class="mb-4 col-xxl-7">
                    <div class="overflow-auto card min-h-390 card-dash">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-right sort" data-sort="completion">
                                                {{ __('Price') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <tbody>
                            @foreach ($topSellingProducts as $product)
                                <tr>
                                    ...
                                    <td> <img src="{{ asset($product->cover_image_path) }}" alt=""
                                            width="100" class="cover_img{{ $product->id }}">
                                    </td>
                                    ...
                                    <td>
                                        @if ($product->variant_product == 1)
                                            <span
                                                class="p-2 rounded badge f-w-600 bg-light-warning">{{ __('In Variant') }}</span>
                                        @else
                                            @if ($product->track_stock == 0)
                                                @if ($product->stock_status == 'out_of_stock')
                                                    <span class="p-2 rounded badge f-w-600 bg-light-danger">
                                                        {{ __('Out of stock') }}</span>
                                                @elseif ($product->stock_status == 'on_backorder')
                                                    <span class="p-2 rounded badge f-w-600 bg-light-warning">
                                                        {{ __('On Backorder') }}</span>
                                                @else
                                                    <span class="p-2 rounded badge f-w-600 bg-light-primary">
                                                        {{ __('In stock') }}</span>
                                                @endif
                                            @else
