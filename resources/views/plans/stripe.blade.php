                                ...
                                @if (isset($admin_payments_details['is_paddle_enabled']) && $admin_payments_details['is_paddle_enabled'] == 'on')
                                    <a href="#paddle_payment"
                                        class="list-group-item list-group-item-action border-0">{{ __('Paddle') }}<div
                                            class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                @endif
                                @if (isset($admin_payments_details['is_paiementpro_enabled']) &&
                                        $admin_payments_details['is_paiementpro_enabled'] == 'on')
                ...
                <div class="col-xl-9">
                    ...
                    @if (isset($admin_payments_details['is_manually_enabled']) && $admin_payments_details['is_manually_enabled'] == 'on')
                        <div id="manually_payment" class="card">
                            ...
                            {{-- <div class="card-body"> --}}
                            @if ($admin_payments_details['is_manually_enabled'] == 'on')
                                <div class="tab-pane {{ ($admin_payments_details['is_manually_enabled'] == 'on') == 'on' ? 'active' : '' }}"
                                    ...
                                    <form role="form" action="#" method="post" class="require-validation"
                                        id="payment-form">
                                        @csrf
                                        <input type="hidden" name="total_price" class="form-control final-price">
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                <a href="{{ route('send.request', [\Illuminate\Support\Facades\Crypt::encrypt($plan->id)]) }}"
                                                    class="btn btn-xs btn-primary" data-title="{{ __('Send Request') }}"
                        ...
                        <div id="coingate_payment" class="card">
                            ...
                            @if (
                                ...
                                <div class="tab-pane {{ ($admin_payments_details['is_coingate_enabled'] == 'on' && !empty($admin_payments_details['coingate_mode']) && !empty($admin_payments_details['coingate_auth_token'])) == 'on' ? 'active' : '' }}"
                                    id="coingate_payment">
                                    <form role="form" action="{{ route('coingate.prepare.plan') }}" method="post"
                                        class="require-validation" id="payment-form">
                                        @csrf
                                        <input type="hidden" name="total_price" value="{{ $plan->price }}"
                                            class="form-control final-price">
                    ...
                    {{-- IyziPay --}}
                    @if (isset($admin_payments_details['is_iyzipay_enabled']) == 'on' &&
                    ...
                    {{-- Benefit --}}
                    @if (isset($admin_payments_details['is_benefit_enabled']) == 'on' &&
                    ...
                    {{-- Cashfree --}}
                    @if (isset($admin_payments_details['is_cashfree_enabled']) == 'on' &&
                        ...
                        <div id="cashfree_payment" class="card">
                            ...
                            <div class="tab-pane {{ ($admin_payments_details['is_cashfree_enabled'] != 'on' && $admin_payments_details['is_cashfree_enabled'] == 'on' && !empty($admin_payments_details['cashfree_secret_key']) && !empty($admin_payments_details['cashfree_key'])) == 'on' ? 'active' : '' }}"
                                id="cashfree_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                    id="payment-form" action="{{ route('cashfree.payment') }}">
                                    @csrf
                                    <input type="hidden" name="plan_id"
                                        value="{{ \Illuminate\Support\Facades\Crypt::encrypt($plan->id) }}">
                    ...
                    {{-- Aamarpay --}}
                    @if (isset($admin_payments_details['is_aamarpay_enabled']) == 'on' &&
                        ...
                        <div id="aamarpay_payment" class="card">
                            ...
                            <div class="tab-pane {{ ($admin_payments_details['is_aamarpay_enabled'] != 'on' && $admin_payments_details['is_aamarpay_enabled'] == 'on' && !empty($admin_payments_details['aamarpay_signature_key']) && !empty($admin_payments_details['aamarpay_store_id']) && !empty($admin_payments_details['aamarpay_description'])) == 'on' ? 'active' : '' }}"
                                id="aamarpay_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                    id="payment-form" action="{{ route('pay.aamarpay.payment') }}">
                                    @csrf
                                    <input type="hidden" name="plan_id"
                                        value="{{ \Illuminate\Support\Facades\Crypt::encrypt($plan->id) }}">
                    ...
                    {{-- Pay TR --}}
                    @if (isset($admin_payments_details['is_paytr_enabled']) == 'on' &&
                    ...
                    {{-- Yookassa --}}
                    @if (isset($admin_payments_details['is_yookassa_enabled']) == 'on' &&
                    ...
                    {{-- Xendit --}}
                    @if (isset($admin_payments_details['is_Xendit_enabled']) == 'on' &&
                    ...
                    {{-- Midtrans --}}
                    @if (isset($admin_payments_details['is_midtrans_enabled']) == 'on' &&
                            !empty($admin_payments_details['midtrans_secret_key']))
                    ...
                    {{-- Nepalste --}}
                    @if (isset($admin_payments_details['is_nepalste_enabled']) == 'on' &&
                            !empty($admin_payments_details['nepalste_secret_key']))
                    ...
                    {{-- PayHere --}}
                    @if (isset($admin_payments_details['is_payhere_enabled']) == 'on' &&
                            !empty($admin_payments_details['payhere_merchant_secret']))
                    ...
                    {{-- AuthorizeNet --}}
                    @if (isset($admin_payments_details['is_authorizenet_enabled']) == 'on' &&
                            !empty($admin_payments_details['authorizenet_login_id']))
                            ...
                            <div class="tab-pane {{ ($admin_payments_details['is_authorizenet_enabled'] != 'on' && $admin_payments_details['is_authorizenet_enabled'] == 'on' && !empty($admin_payments_details['authorizenet_login_id'])) == 'on' ? 'active' : '' }}"
                                ...
                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                    ...
                                    <div class="col-sm-12 my-2 px-2">
                                        <div class="text-end">
                                            <input type="submit" value="{{ __('Pay Now') }}"
                                                class="btn btn-primary payment_method payment-btn"
                    ...
                    {{-- PhonePe --}}
                    @if (isset($admin_payments_details['is_phonepe_enabled']) == 'on' &&
                            !empty($admin_payments_details['phonepe_merchant_key']))
                    ...
                    {{-- Paiement Pro --}}
                    @if (isset($admin_payments_details['is_paiementpro_enabled']) == 'on' &&
                            !empty($admin_payments_details['paiementpro_merchant_id']))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6" id="mobile_div">
                                                ...
                                                <input type="text" name="mobile_number"
                                                    class="form-control font-style mobile_number" id="mobile_number"
                                                    required>
                                            </div>
                                            <div class="form-group col-md-6" id="channel_div">
                                                {{ Form::label('channel', __('Channel'), ['class' => 'form-label']) }}
                                                <input type="text" name="channel"
                                                    class="form-control font-style channel" id="channel" required>
...
@push('custom-script')
    ...
    <script type="text/javascript">
        ...
        @if (isset($admin_payments_details['is_payfast_enabled']) == 'on' &&
                !empty($admin_payments_details['payfast_merchant_id']) &&
                !empty($admin_payments_details['payfast_merchant_key']))
            $(document).ready(function() {
