                                    ...
                                    <div class="blog-widget col-md-12 col-sm-6 col-12">
                                        <div class="blog-widget-inner">
                                            ...
                                            <div class="blog-caption">
                                                <h4><a href="{{ route('page.article', ['storeSlug' => $slug, $data->id]) }} "
                                                        class ="descriptions">{{ $data->title }}</a></h4>
                                                <p>{{ $data->short_description }}</p>
                                                <div class="blog-lbl-row d-flex align-items-center justify-content-between">
                                                    <a class="btn blog-btn"
                                                        href="{{ route('page.article', ['storeSlug' => $slug, $data->id]) }}">
                                                        {{ __('Read more') }}
                    ...
                    @foreach ($l_articles as $blog)
                        <div class=" blog-widget d-flex">
                            <div class="blog-widget-inner">
                                ...
                                <div class="blog-caption">
                                    <h4><a href="{{ route('page.article', [$currentTheme, $data->id]) }}"
                                            class="descriptions">{{ $blog->title }}</a></h4>
                                    <p>{{ $blog->short_description }}</p>
                                    <div class="blog-lbl-row d-flex align-items-center justify-content-between">
                                        <a class="btn blog-btn"
                                            href="{{ route('page.article', [$currentTheme, $data->id]) }}">
                                            {{ __('Read more') }}
