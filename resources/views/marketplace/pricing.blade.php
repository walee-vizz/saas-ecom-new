                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="price d-flex justify-content-between">
                                                            <ins class="m-price-monthly"><span
                                                                    class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price'] ?? 0) }}</span>
                                                                <span
                                                                    class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                            <ins class="m-price-yearly d-none"><span
                                                                    class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'] ?? 0) }}</span>
                                                                <span
